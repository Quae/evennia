...
class TestCmdLink(CollabTest, CollabCommandTestMixin):
    ...
    def test_game_priority(self):
        """
        Make sure an exit commandset on room or object doesn't take precedence over the system-wide commands.
        """


    def test_override_priority(self):
        """
        Verify that exits with override privileged override settings do take precedence when they otherwise wouldn't.
        """
